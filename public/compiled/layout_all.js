...
}),$("div.bilan table").on("click","tr td:nth-child(2)",function(t){var e,n,r;return e=$(t.target).prev().text(),n=window.jsp.urlAlinea,n=n.replace("[:id]",e),n=n.replace("[:type]","show"),r=window.open("","_blank"),t.preventDefault(),null===r&&alert("Autorisez cette page à ouvrir des popups."),r.location.href=n
})},t}();