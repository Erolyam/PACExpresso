...
return a="result",null!=n.Qaire.solution_json&&(console.log(n.Qaire.solution_json),a="result-wrong",i=JSON.parse(n.Qaire.submited_data_json)[r],s=JSON.parse(n.Qaire.solution_json)[r],i===s&&(a="result-right")),o="<li class='"+a+"' data-alineaid='"+t+"' data-num='"+r+"'>"+(r+1)+"</li>",e.append($(o))
...
}).done(function(t,e,r){return 200===r.status&&r.getResponseHeader("content-type").startsWith("application/json")?(n.Qaire=JSON.parse(r.responseText),n.solutionsReceived()):(alert("Le serveur n'a pas pu enregistrer le questionnaire"),void 0)
