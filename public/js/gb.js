...
window.gb.startsWith = function(s, needle) {
  var _ref;
  return (s != null ? (_ref = s.toString()) != null ? _ref.slice(0, needle.length) : void 0 : void 0) === needle;
};

window.gb.endsWith = function(s, needle) {
  var _ref;
  return (s != null ? (_ref = s.toString()) != null ? _ref.slice(-needle.length) : void 0 : void 0) === needle;
};
...
window.gb.jqAjaxJSON = (function(_this) {
  return function(url, settings) {
    ...
    if (settings.complete != null) {
      settings.originalComplete = settings.complete;
    }
    settings.complete = function(jqxhr) {
      ...
      if (window.gb.startsWith(contenttype, "application/json")) {
        ...
        if (settings.originalComplete != null) {
          return settings.originalComplete.apply(_this, [jqxhr.responseJSON, jqxhr]);
        }
      } else {
        return alert("erreur: Réponse du serveur non json");
      }
    };
