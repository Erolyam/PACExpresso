...
window.gb.urlHelper = function(url, params) {
  ...
  if (url.toLowerCase().substr(0, 7) === "http://") {
    proto = url.substr(0, 7);
    url = url.substr(7);
  }
  if (url.toLowerCase().substr(0, 8) === "https://") {
    proto = url.substr(0, 8);
    url = url.substr(8);
  }
  for (key in params) {
  ...
  return function(url, settings) {
    ...
    if (settings.error == null) {
      settings.error = function(jqxhr, textstatus, errorThrown) {
        var err;
        err = window.gb.utf8_decode(errorThrown);
        return alert("erreur: " + err);
      };
    }
...
/*
 * Come from http://ecmanaut.blogspot.fr/2006/07/encoding-decoding-utf8-in-javascript.html
 */

window.gb.utf8_decode = function(str) {
  try {
...
window.gb.utf8_encode = function(str) {
  try {
